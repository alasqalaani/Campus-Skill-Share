    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] animate-in fade-in slide-in-from-bottom-8 duration-700">
      <div className="max-w-3xl text-center space-y-8">
        ...
        <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
          Need help with Python? Want to learn guitar? Campus Skill Share is the noticeboard for human skills. 
          Connect with peers, trade your talents, and learn something new.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-16 mt-16 border-t border-border/50">
          {[
            { icon: Users, title: "Verified Peers", desc: "Connect safely with other students on campus." },
            { icon: Zap, title: "Any Skill", desc: "From organic chemistry tutoring to graphic design." },
            { icon: BookOpen, title: "Learn & Earn", desc: "Charge a rate or trade skills for free." }
          ].map((feature, i) => (
            <div key={i} className="flex flex-col items-center text-center space-y-3 p-6 rounded-2xl bg-card border border-border shadow-sm hover:shadow-md transition-shadow">
